...
const citiesData = [
  ...
  },
  {
    ...
    facts: [
      ...
      'Летом остров привлекает туристов цветущими лавандовыми полями.',
    ],
  },
  {
    name: 'Нагоя',
...
const CitySelector = ({ onSelect }) => {
  const handleChange = (e) => {
    const selectedCity = citiesData.find((city) => city.name === e.target.value)
    onSelect(selectedCity)
  }

  return (
    <div className={styles.selector}>
      <h2 className={styles.label}>Выберите город:</h2>
